    ...
    public partial class CreateDatabase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArchivingVacancy", x => x.ArchivedVacancyId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Vacancy_Employer_EmployeeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicantVacancies", x => new { x.ApplicantId, x.VacancyId });
                    table.ForeignKey(
                        name: "FK_ApplicantVacancies_Applicant_ApplicantId",
                        column: x => x.ApplicantId,
                        principalTable: "Applicant",
                        principalColumn: "UserId");
                    table.ForeignKey(
                        name: "FK_ApplicantVacancies_Vacancy_VacancyId",
